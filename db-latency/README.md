...
:::note info
このリポジトリを開いた状態で GitHub Copilot Agent Mode に「XXXサブスクリプションにAZDで環境を作成してください」と依頼することも可能です。この場合ステップ3まで手順をスキップできます。
:::
...
## ステップ 6: 常時発生するスロークエリで遅延を可視化する

:::note info
このリポジトリを開いた状態で GitHub Copilot Agent Mode に「負荷をかけるスクリプトを実行してください」と依頼することも可能です。
:::
...
## ステップ 7: Azure portal で SQL と Cosmos DB を切り分ける

### 7.1 Application Insights の Performance と Transaction diagnostics
...
## ステップ 8: Azure SRE Agent に原因を説明させる
